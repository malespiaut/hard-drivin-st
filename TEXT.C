...
static void	PrintZiffer( int x, int y, int ziffer)

 {	switch( ziffer)
	{	case 0 : m(x0,y0)  d(x5,y0)  d(x5,y5)  d(x0,y5)  d(x0,y0)
			 m(x0,y5)  d(x5,y0)
			 break;
		case 1 : m(x1,y2)  d(x3,y0)  d(x3,y5)
			 m(x1,y5)  d(x5,y5)
			 break;
		case 2 : m(x0,y0)  d(x5,y0)  d(x5,y2)  d(x0,y2)  d(x0,y5)  d(x5,y5)
			 break;
		case 3 : m(x0,y0)  d(x5,y0)  d(x5,y5)  d(x0,y5)
			 m(x1,y2)  d(x5,y2)
			 break;
		case 4 : m(x0,y0)  d(x0,y2)  d(x5,y2)  d(x5,y0)  d(x5,y5)
			 break;
		case 5 : m(x5,y0)  d(x0,y0)  d(x0,y2)  d(x5,y2)  d(x5,y5)  d(x0,y5)
			 break;
		case 6 : m(x0,y0)  d(x0,y5)  d(x5,y5)  d(x5,y2)  d(x0,y2)
			 break;
		case 7 : m(x0,y0)  d(x5,y0)  d(x5,y5)
			 break;
		case 8 : m(x0,y0)  d(x5,y0)  d(x5,y5)  d(x0,y5)  d(x0,y0)
			 m(x0,y2)  d(x5,y2)
			 break;
		case 9 : m(x5,y5)  d(x5,y0)  d(x0,y0)  d(x0,y2)  d(x5,y2)
			 break;
		default : break;
	}
 }
...
static void	PrintText( int x, int y, char *text, int color)
 ...
 {	register int	ch;
	...
	{	if (ch == ' ')
		...
		switch(ch)
		{ case 'a' :	m(x0,y5) d(x0,y2) d(x2,y0) d(x3,y0) d(x5,y2)
				d(x5,y5) m(x0,y2) d(x5,y2)
				break;
		  case 'b' :	m(x0,y2) d(x4,y2) d(x5,y2) d(x5,y1)
		  		d(x4,y0) d(x0,y0) d(x0,y5) d(x4,y5)
		  		d(x5,y4) d(x5,y3) d(x4,y2)
		  		break;
		  case 'c' :	m(x5,y0) d(x0,y0) d(x0,y5) d(x5,y5)
				break;
		  case 'd' :	m(x0,y0) d(x0,y5) d(x3,y5) d(x5,y3) d(x5,y2)
		  		d(x3,y0) d(x0,y0)
				break;
		  case 'e' :	m(x5,y0) d(x0,y0) d(x0,y5) d(x5,y5)
				m(x0,y2) d(x4,y2)
				break;
		  case 'f' :	m(x5,y0) d(x0,y0) d(x0,y5) m(x0,y2) d(x4,y2)
				break;
		  case 'g' :	m(x5,y0) d(x0,y0) d(x0,y5) d(x5,y5) d(x5,y2)
				d(x3,y2)
				break;
		  case 'h' :	m(x5,y0) d(x5,y5) m(x0,y0) d(x0,y5)
				m(x0,y2) d(x5,y2)
				break;
		  case 'i' :	m(x2,y0) d(x2,y5) m(x0,y0) d(x4,y0)
		  		m(x0,y5) d(x4,y5)
		  		break;
		  case 'j' :	m(x5,y0) d(x5,y5) d(x2,y5) d(x0,y3)
		  		break;
		  case 'k' :	m(x0,y0) d(x0,y5)
		  		m(x5,y0) d(x0,y2) d(x5,y5)
		  		break;
		  case 'l' :	m(x0,y0) d(x0,y5) d(x5,y5)
		  		break;
		  case 'm' :	m(x0,y5) d(x0,y0) d(x2,y2) d(x3,y2) d(x5,y0)
		  		d(x5,y5)
		  		break;
		  case 'n' :	m(x0,y5) d(x0,y0) d(x5,y5) d(x5,y0)
		  		break;
		  case 'o' :	m(x0,y0) d(x0,y5) d(x5,y5) d(x5,y0) d(x0,y0)
				break;
		  case 'p' :	m(x0,y5) d(x0,y0) d(x5,y0) d(x5,y2) d(x0,y2)
		  		break;
		  case 'q' :	m(x5,y5) d(x5,y0) d(x0,y0) d(x0,y5) d(x5,y5)
		  		d(x3,y3)
				break;
		  case 'r' :	m(x0,y5) d(x0,y0) d(x5,y0) d(x5,y2) d(x0,y2)
				m(x2,y2) d(x5,y5)
				break;
		  case 's' :	m(x5,y0) d(x0,y0) d(x0,y2) d(x5,y2) d(x5,y5)
				d(x0,y5)
				break;
		  case 't' :	m(x0,y0) d(x4,y0) m(x2,y0) d(x2,y5)
		  		break;
		  case 'u' :	m(x0,y0) d(x0,y5) d(x5,y5) d(x5,y0)
		  		break;
		  case 'v' :	m(x0,y0) d(x3,y5) d(x6,y0) x++;
				break;
		  case 'w' :	m(x0,y0) d(x0,y5) d(x2,y3) d(x3,y3) d(x5,y5)
				d(x5,y0)
				break;
		  case 'x' :	m(x0,y0) d(x5,y5) m(x0,y5) d(x5,y0)
		  		break;
		  case 'y' :	m(x0,y0) d(x2,y2) d(x4,y0) m(x2,y2) d(x2,y5)
		  		break;
		  case 'z' :	m(x0,y0) d(x5,y0) d(x0,y5) d(x5,y5)
		  		break;
		  case '-' :	m(x0,y2) d(x5,y2)
		  		break;
		  case '_' :	m(x0,y5) d(x5,y5)
		  		break;
		  case '.' :	m(x1,y5) d(x1,y5)
		  		break;
		  case ',' :	m(x2,y4) d(x2,y5) d(x1,y6)
		  		break;
		  case '\'':	m(x1,y0) d(x1,y1)
		  		break;
		  case ':' :	m(x2,y4) d(x2,y4) m(x2,y2) d(x2,y2)
		  		break;
		  case '@' :	m(x1,y0) d(x5,y0) d(x6,y1) d(x6,y5)
		  ...
		  case '*' :	m(x1,y0) d(x5,y0) d(x6,y1) d(x6,y5)
		  		...
		  		x++;  break;
		  case '+' :	m(x1,y3) d(x5,y3) m(x3,y1) d(x3,y5)
		  		break;
		  case '(' :	m(x2,y0) d(x0,y2) d(x0,y4) d(x2,y6)
		  		break;
		  case ')' :	m(x4,y0) d(x6,y2) d(x6,y4) d(x4,y6)
		  		break;
		  case '/' :	m(x0,y5) d(x5,y0)
		  		break;
		  case '&' :	m(x5,y3) d(x3,y5) d(x2,y5) d(x1,y4)
...
void	TypeValue( int x, int y, long value, int color)
...
{	extern	char	MessageTime, MessageCode;
	...
	switch (MessageCode)
	{
		case msg_extra :	SetTextColor( white);
					PrintString( 15, 25, "EXTRA TIME.");
					break;

		case msg_extended :	SetTextColor( white);
					PrintString( 14, 25, "EXTENDED PLAY.");
					break;

		case msg_qualified :	SetTextColor( white);
					PrintString( 13, 15, "EXTENDED PLAY.");
					SetTextColor( yellow);
					PrintString(  7, 25, "QUALIFIED FOR CHAMPIONSHIP.");
					break;

		case msg_great :	SetTextColor( white);
					PrintString( 13, 15, "EXTENDED PLAY.");
					SetTextColor( yellow);
					PrintString( 11, 25, "ANOTHER GREAT LAP.");
					break;

		case msg_won:		SetTextColor( white);
					PrintString( 17, 20, "YOU WON \014\014.");
					break;

		case msg_lost:		SetTextColor( white);
					PrintString( 17, 20, "YOU LOST \014\014.");
					break;

		case msg_disqualified:	SetTextColor( yellow);
...
{	extern	 char		TimeOutFlag, StartMessage;
	...
	{	sec = (int) (TimeOut >> 2*4);
		...
		if (sec != seconds)
		{	seconds = sec;
			number[3] = sec & 15;	sec >>= 4;
			number[2] = sec & 15;	sec >>= 4;
			number[0] = sec & 15;
		}
