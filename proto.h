...
int* RotXY(int count, int cos, int sin, int far* dest, int far* source);
int* RotXZ(int count, int cos, int sin, /* Rotation of a [x,y,z] array with count elements. */
           int far* dest,
           int far* source);
int* RotYZ(int count, int cos, int sin, int far* dest, int far* source);
...
void SysToVid(int x1, int y1, int x2, int y2, void far* source, void far* dest); /* NO CLIPPING AND RANGE CHECK !!. */
void VidToVid(int x1, int y1, int x2, int y2, void far* source, void far* dest); /* NO CLIPPING AND RANGE CHECK !!. */
...
void CopySmallScreen(int y1, int y2, void far* source, void far* dest); /* Copy window screen. */
int FileRead(char* name, void far* addr);                               /* Read the file "name" into the buffer at addr. */
int FixedRead(char* name, void far* addr, long size);                   /* Read size bytes of "name" into the buffer at addr. */
void FileWrite(char* name, void far* addr, long size);                  /* Read the file "name" into the buffer at addr. */
